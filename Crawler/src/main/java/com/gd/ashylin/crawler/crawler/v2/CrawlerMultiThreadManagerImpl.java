...
public class CrawlerMultiThreadManagerImpl extends Thread implements CrawlerMultiThreadManager {
    ...
    private void initialize() {
        ...
        Crawler crawler = new CrawlerImpl(initialScrap, mainPageUrl, scrapResult -> tryAddTask(scrapResult), cache, enableCaching);
    ...
    public void setCache(Cache<String, CacheDto> cache) {
        this.cache = cache;
    }
