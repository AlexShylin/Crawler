 ...
 */
@RestController
@RequestMapping("/v2/crawlers")
public class CrawlersRestControllerV2 {
    ...
    public LaunchResponseBinding launchCrawlerRequest(@RequestBody LaunchRequestBindingV2 requestBinding) {
        LaunchDto launchDto = crawlersService.launch(requestBinding.getUrl(), requestBinding.getThreads(), requestBinding.getDelay(), requestBinding.getEnableCaching());
