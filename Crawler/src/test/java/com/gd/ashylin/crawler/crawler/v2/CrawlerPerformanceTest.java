...
public class CrawlerPerformanceTest {
    ...
    public void testCrawler() throws InterruptedException {
        ...
        LOGGER.info("Started performance test Crawler v2 on " + url);

        long start = System.currentTimeMillis();
        CrawlerMultiThreadManagerImpl mm = new CrawlerMultiThreadManagerImpl();
        mm.setUrl(url);
        mm.setThreads(THREADS_NUM);
        mm.setDelay(DELAY);
        ...
        LOGGER.info("Finished performance test Crawler v2 on " + url + durationString + elementsCount);
    }
